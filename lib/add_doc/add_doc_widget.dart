  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<SpecialityRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SpecialityRow> addDocSpecialityRowList = snapshot.data!;
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child:
                                            FutureBuilder<List<SpecialityRow>>(
                                          future: SpecialityTable().queryRows(
                                            queryFn: (q) => q,
                                          ),
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                  ...
                                                  FormFieldController<String>(
                                                      null),
                                              options: dropDownSpecialityRowList
                                                  .map((e) => e.spec)
                                                  .withoutNulls
                                                  .toList(),
                                              onChanged: (val) async {
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await DoctorTable().insert({
                                          'Dphone_No':
                                              _model.numTextController.text,
                                          'specification': _model.spec,
                                          'Dusername':
