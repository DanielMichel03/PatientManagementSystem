...
class _AddpatientWidgetState extends State<AddpatientWidget> {
  ...
  void initState() {
    ...
    _model.numFocusNode!.addListener(() => setState(() {}));
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<SpecialityRow>>(
      future: SpecialityTable().queryRows(
        queryFn: (q) => q,
      ),
      builder: (context, snapshot) {
        ...
        List<SpecialityRow> addpatientSpecialityRowList = snapshot.data!;
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              await PatientTable().insert({
                                                'Pphone_No': _model
                                                    .numTextController.text,
                                                'Pusername': _model
                                                    .nameTextController.text,
                                                'PDOB': supaSerialize<DateTime>(
                                                    _model.datePicked),
                                              });
                                            },
                                            text: 'Add Patient',
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              if (_model.spec! > 0)
                                                FutureBuilder<List<DoctorRow>>(
                                                  future:
                                                      DoctorTable().queryRows(
                                                    queryFn: (q) => q.eq(
                                                      'specification',
                                                      _model.spec,
                                                    ),
                                          ...
                                          if (_model.doc! > 0)
                                            Row(
                                              ...
                                              mainAxisAlignment:
                                                  MainAxisAlignment.center,
                                              children: [
                                                FutureBuilder<List<DocAptRow>>(
                                                  future:
                                                      DocAptTable().queryRows(
                                                    queryFn: (q) => q.eq(
                                                      'doc',
                                                      _model.doc,
                                                    ),
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await AppointmentTable().insert({
                                            ...
                                            'Patient_id':
                                                _model.patient?.first?.id,
                                            'Doctor_id':
                                                _model.chosendoc?.first?.id,
                                            'State': 1,
                                          });
